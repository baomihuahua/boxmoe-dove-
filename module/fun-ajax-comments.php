...
if(!is_user_logged_in() & boxmoe_com('false_enjp_comment')) {
...
<?php echo get_avatar( $comment->comment_author_email, 60,'','',array('class'=>array('img-fluid'))); ?>  
</div>
</div>
</div>
<div class="comment-body">
<div class="meta-data">
<span class="commentsbadge yourcomment"><i class="fa fa-heart"></i>这是你刚发布的评论</span>
<span class="comment-author"><a href="<?php echo esc_url( get_comment_author_url( $comment ) ); ?>" rel="external nofollow" target="_black"><?php comment_author(); ?></a> </span>
